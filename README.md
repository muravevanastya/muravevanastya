...
#### :black_small_square: Привет! Меня зовут Анастасия. Я начинающий фронтенд-разработчик.

:black_small_square: Я хочу заниматься увлекательным интеллектуальным трудом, в котором есть пространство для творчества и саморазвития. 

:black_small_square: На данный момент я:
...
:black_small_square: __Моя цель - не стабильность, а постоянное развитие своих навыков.__
